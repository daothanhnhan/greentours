<?php 
	$visa_vietnam_page = $action->getDetail('page', 'page_id', 52);
?>
...
<div class="container-f">
	...
	<div class="row">
		...
		<section id="block-peak-navigation-peak-anchor-side-menu"
			...
			<!--<ul class="icon-fixed-visa">

				<li><a href="#visa-info">Visa info</a></li>

				<li><a href="#faq">FAQs</a></li>

				 <li><a href="#voa">VOA form</a></li>

				<li><a href="#evisa">Evisa form</a></li>
		...
		<div class="col-md-8">
			...
			<?php include DIR_NEWS."MS_NEWS_GREEN_0012.php";?>

			<!-- <p><a id="voa" href="/apply-vietnam-visa-voa" title="" style="font-size: 24px;font-weight: bold;">VOA application form</a></p> -->

			<p><a id="evisa" href="/apply-cambodia-evisa" title="" style="font-size: 24px;font-weight: bold;background-color: #b51c1c;color: #fff;padding: 10px;border-radius: 5px;">Apply Cambodia Evisa</a></p>
