        ...
        <section class="col-sm-12 col-md-9 col-lg-9">
            ...
            <div class="u-margin-top-3 itinerary-section">
                ...
                <div class="panel-group" data-template="peak-shortcode-aggregate--display-accordion">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">
                                ...
                                <a data-toggle="collapse" data-parent="#accordion" class="collapsed"
                                    ...
                                    href="#panel-toggle-<?= $d ?>" aria-expanded="false">

                                    Day <?= $d ?>: <?= $item['name'] ?> <div class="pull-right accordion-expander">
                        ...
                        <div id="panel-toggle-<?= $d ?>" class="panel-collapse collapse"
            ...
            <div class="row inclusions-section hidden-xs u-margin-top-3">
                ...
                <div class="col-sm-12">
                    ...
                    <h2 id="inclusions" data-anchortext="Inclusions" data-faicon="check">Inclusions</h2>
                    ...
                    <div class="activity col-xs-3 col-sm-12">
                        ...
                        <div class="activity-description hidden-xs">
            ...
            <div class="row inclusions-section-tabs visible-xs-block u-margin-top-3">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="accomadation">
            ...
            <div class="u-margin-top-3 important-notes-section">
                ...
                <h2 id="Dates" data-anchortext="Important notes" data-faicon="pencil-square-o">Dates & Price
                ...
                <div class="row">
                    ...
                    <div class="col-md-5" id="book-tour-2" style="">
                        ...
                        <a href="/customize-this-tour/<?= $row['product_id'] ?>" style="">Customize your trip</a>
            ...
            <div class="u-margin-top-3 important-notes-section">
                ...
                <h2 id="fact-box-notes" data-anchortext="Important notes" data-faicon="pencil-square-o">Important notes
