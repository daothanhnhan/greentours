<?php
    if(isset($_SESSION['user_name_gbvn'])){
        echo '<script type="text/javascript">window.location.href = "/thong-tin-tai-khoan";</script>';
    }
?>
<?php 
    $message = "";
        ...
        if (isset($_POST['register'])) {
            ...
            if ($check == "true") {
                ...
                if ($result) {
                  ...
                  echo '<script type="text/javascript">alert(\'You have successfully registered!\'); window.location.href = "/thong-tin-tai-khoan";</script>';
                } else {
...
<?php 
    ...
    function dangnhap () {
        ...
        if (isset($_POST['login'])) {
            ...
            if ($num == 0) {
                $message_login = "<div class='alert alert-danger'>Password or Username is incorrect</div>";
            } else {
                ...
                if (password_verify($pass, $pass_hash)) {
                    ...
                    echo '<script type="text/javascript">alert(\'Successful login!\'); window.location.href = "/thong-tin-tai-khoan";</script>';
                } else {
                    $message_login = "<div class='alert alert-danger'>Password or Username is incorrect</div>";
                }
            }
...
<?php 
  function forgetPass () {
    ...
    if (isset($_POST['forget'])) {
      ...
      $num = mysqli_num_rows($result);
      if ($num == 0) {
         echo '<script type="text/javascript">alert(\'This account does not exist.\');</script>';
         return false;
      } else {
        $row = mysqli_fetch_assoc($result);
        if ($row['ask'] == '') {
          echo '<script type="text/javascript">alert(\'This account is not valid.\');</script>';
        } else {
          $ask_hash = $row['ask'];
          if (password_verify($ask, $ask_hash)) {
            $_SESSION['user_id_gbvn'] = $row['user_id'];
            $_SESSION['user_name_gbvn'] = $row['user_name'];
            echo '<script type="text/javascript">alert(\'Please change your password.\');window.location.href = "/doi-mat-khau";</script>';
          } else {
            echo '<script type="text/javascript">alert(\'The information entered is not valid.\');</script>';
          }
        }
      }
    }
                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <a href="#0" data-toggle="modal" data-target="#khoiphucmatkhau">Forget your password?</a>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <button class="btn btn-dangnhap_excel" name="login">Sign in</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="gb-dangky_tour-right">
                        ...
                        <div class="gb-form-dangky">
                            ...
                            <form action="" method="post">
                                <?= $message ?>
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Full name" value="<?= (isset($_POST['name'])) ? $_POST['name'] : '' ?>" required>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="tel" name="phone" class="form-control" placeholder="Phone number" value="<?= (isset($_POST['phone'])) ? $_POST['phone'] : '' ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="date" name="birthday" class="form-control" placeholder="Birthday" value="<?= (isset($_POST['birthday'])) ? $_POST['birthday'] : '' ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Security question: What do you like?" name="ask" required="" value='<?php if(isset($_POST['ask']) && $_POST['ask'] != NULL){ echo $_POST['ask']; } ?>' >
                                </div>
                                <div class="form-group">
                                    <p>By clicking below to sign up, you're agreeing to <a href="#0"  data-toggle="modal" data-target="#product_view">our Terms of service.</a></p>
                                </div>
                                <div class="form-group">
                                    <button name="register" class="btn btn-taotaikhoan">Create account</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="modal fade product_view" id="khoiphucmatkhau">
        <div class="modal-dialog" style="margin-top: 90px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <p>Enter your email in the box below to continue</p>
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" placeholder="Enter email" required>
                        </div>
                        <p>Enter your security question into the box below</p>
                        <div class="form-group">
                            <input type="text" class="form-control" name="ask" placeholder="What do you like the most" required>
                        </div>
                        <div class="form-group">
                            <button class="btn btn-xacnhan" name="forget">Confirm</button>
                        </div>
                    </form>
                </div>
            </div>
