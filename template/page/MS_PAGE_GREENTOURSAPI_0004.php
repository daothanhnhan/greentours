<?php 
  function order () {
    ...
    if (isset($_POST['thanh_toan'])) {
      ...
      echo '<script type="text/javascript">alert(\'You have successfully booked the visa.\')</script>';
    }
  }
  order();
?>
...
// var_dump($_SESSION['info_order_visa']);
  ...
  $airport = $action->getList('airport_arrival', 'type', $airport_item['type'], 'id', 'asc', '', '', '');
...
// echo '<script type="text/javascript">alert(\'Payment Success.\')</script>';
    if ($_SESSION['info_order_visa']['rush'] == 180) {
      ...
      $amount = $price_country + ($_SESSION['info_order_visa']['time'] + $_SESSION['info_order_visa']['private'] + $_SESSION['info_order_visa']['fasttrack']) * $count_price;
    }
// $amount = $price*$count;
    ...
    <div class="col-sm-6">
      <div class="order1">
        ...
        <div class="visa-type">
          ...
          <div class="select-visa-type">
            <div class="item">
              <select name="type" id="type" class="" onchange="typef(this)">
            ...
            <div class="item">
              ...
              <div class="right" style="">
                <select name="purpose" id="purpose" class="" onchange="purposef(this)">
            ...
            <div class="item">
              ...
              <div class="right" style="">
                <select name="airport" id="airport" class="" onchange="set_airport(this)">
      ...
      <div class="order2" style="border-top: 0;border-bottom: 0;">
        ...
        <div class="item">
          <select name="express" id="express" class="express" disabled>  
            <option value="1" <?= $_SESSION['info_order_visa']['time']==0 ? 'selected' : '' ?> >Standard 2 Working days (Business hour Mon to Fri)</option>
        ...
        <div class="item">
          ...
          <div class="right" style="">
            <?php 
            if ($_SESSION['info_order_visa']['rush'] == 180) {
              $rush_fee = $_SESSION['info_order_visa']['rush'] * $count_price;
            } else {
              $rush_fee = 0;
            }
            echo '$'.$rush_fee;
        ...
        <div class="item" style="display: <?= $airport_item['type']==1 ? 'block' : 'none'; ?>">
          <div class="item-name" style="display: inline;">
            <input type="radio" name="private" class="radio1" onclick="set_private()" previousvalue="<?= $_SESSION['info_order_visa']['private']==8 ? 'checked' : 'false' ?>" <?= $_SESSION['info_order_visa']['private']==8 ? 'checked' : '' ?> > Private/confidential Letter (show me in private letter)
          </div>
          <div class="right" id="private" style="">
            $<?= $_SESSION['info_order_visa']['private'] * $count_price ?>
          </div>
        </div>
        <div class="item" style="display: <?= $airport_item['type']==1 ? 'block' : 'none'; ?>">
          <div class="item-name" style="display: inline;">
            <input type="radio" name="fasttrack" class="radio1" onclick="set_fasttrack(30)" <?= $_SESSION['info_order_visa']['fasttrack']==30 ? 'checked' : '' ?> previousvalue="<?= $_SESSION['info_order_visa']['fasttrack']==30 ? 'checked' : 'false' ?>" > Airport Fasttrack - Normal
          </div>
          <div class="right" id="fasttrack1" style="">
            <?php 
            if ($_SESSION['info_order_visa']['fasttrack'] == 30) {
              $fasttrack_fee = 30 * $count_price;
              echo '$' . $fasttrack_fee;
            } else {
              echo '$0';
            }
        ...
        <div class="item" style="display: <?= $airport_item['type']==1 ? 'block' : 'none'; ?>">
          <div class="item-name" style="display: inline;">
            <input type="radio" name="fasttrack" class="radio1" onclick="set_fasttrack(45)" <?= $_SESSION['info_order_visa']['fasttrack']==45 ? 'checked' : '' ?> previousvalue="<?= $_SESSION['info_order_visa']['fasttrack']==45 ? 'checked' : 'false' ?>" > Airport Fasttrack - VIP
          </div>
          <div class="right" id="fasttrack2" style="">
            <?php 
            if ($_SESSION['info_order_visa']['fasttrack'] == 45) {
              $fasttrack_fee = 45 * $count_price;
              echo '$' . $fasttrack_fee;
            } else {
              echo '$0';
            }
      ...
      <div class="order3" style="padding: 0;">
        ...
        <div style="width: 30%;display: inline-block;text-align: right;background: #fcf8e3;color: #BB0000;padding-top: 12px;padding-bottom: 12px;font-weight: bold;font-size: 22px;float: right;">
          ...
          <?php } else { ?>
          <span style="margin-right: 10px;" id="total"><?= $price_country + ($_SESSION['info_order_visa']['time'] + $_SESSION['info_order_visa']['private'] + $_SESSION['info_order_visa']['fasttrack']) * $count_price ?></span>
          <?php } ?>
        </div>
      ...
      <div class="payment">
        ...
        <div class="content">
          ...
          <div class="img-center" style="text-align: center;">
            <!-- <a href="/order-visa"><img src="/images/green/pay_paypal.png" alt=""></a> -->
