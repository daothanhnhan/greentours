<?php 
	...
	$airport = $action->getList('airport_arrival', 'type', '1', 'id', 'asc', '', '', '');
?>
		...
		<div class="col-md-7">
			<form class="form-horizontal" action="/action_page.php">
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			        <select name="purpose" id="purpose" class="form-control" onchange="purposef(this)">
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			        <select name="type" id="type" class="form-control" onchange="typef(this)">
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			        ...
			        <select name="year1" id="year1" class="form-control" style="width: 32%;display: inline-block;" onchange="check_date()">
						<?php 
						$year = date('Y');
						for ($i=0;$i<=5;$i++) { 
							$value = $year + $i;
			        ...
			        <div style="margin-top: 7px;"><span style="color: red;">Noted: It’s the date of arrival Vietnam airport</span></div>
			    ...
			    <div class="form-group">
			      <label class="control-label col-sm-4 left" for="email">Arrival airport (*)</label>
			      <div class="col-sm-8">
			    ...
			    <hr>
			    <div class="form-group">
			      <label class="control-label col-sm-4 left" for="pwd">Processing time (*)</label>
			      <div class="col-sm-8">          
			        <div class="radio" id="show-time-1">
					  <label><input type="radio" id="radio-visa-time-stick-1" name="time" style="top: 3px;" onclick="radio_check(1)" checked>Standard 2 Working days (Business hour Mon to Fri)</label>
					  <div style="padding: 14px;" id="radio-visa-time-1">
					  	<p>We guaranteed to delivery of your approval letter in 2 working days by email (Hanoi Time GMT+7 at 6.30 PM)</p>
						<p style="color: red;">(Government Business Hours: Mon- Fri). We're able support tourist visa on arrival in weekend-holiday</p>
					  </div>		
					</div>
					<div class="radio" id="show-time-2">
					  <label><input type="radio" id="radio-visa-time-stick-2" name="time" style="top: 3px;" onclick="radio_check(2)">Rush 4-8 Working Hours (Business hour Mon to Fri)</label>
					  <div style="padding: 14px;display: none;" id="radio-visa-time-2">
					  	<p>We guaranteed to delivery of your visa approval letter in 1 working days by email (Hanoi Time GMT+7 at 6.30 PM)</p>
						<p style="color: red;">(Government Business Hours: Mon- Fri). We're able support tourist visa on arrival in weekend-holiday</p>
					  </div>
					</div>
					<div class="radio" id="show-time-3">
					  <label><input type="radio" id="radio-visa-time-stick-3" name="time" style="top: 3px;" onclick="radio_check(3)">Emergency Processing (Support 24/7)</label>
					  <div style="padding: 14px;display: none;" id="radio-visa-time-3">
					  	<p>We guaranteed to delivery of your visa approval letter within 60 minutes process by email (Hanoi Time GMT+7 at 6.30 PM)</p>
						<p style="color: red;">(It may unable to send letter from midnight 00.00 AM to before 08.00 AM in the morning Hanoi time. May call us for help). We're able support tourist visa on arrival in weekend-holiday</p>
					  </div>
					</div>
			      </div>
			    </div>
			    <hr>
			    <div class="form-group">
			      <label class="control-label col-sm-4 left" for="pwd">Extra services</label>
			      <div class="col-sm-8">          
			        <div class="radio">
					  <label><input type="radio" class="radio" name="private" style="top: 3px;" onclick="radio_check_extra(1)">Private/confidential Letter (show me in private letter)</label>
					  <div style="padding: 14px;display: none;" id="radio-visa-extra-1">
					  	<p>Because of Vietnam Immigration Office policy, they're list a number of applicant on the same visa letter, so we offered private/confidential visa letter is showing only your name or your group in a letter without others applicants on your letter. Pay in extra 8USD/letter for you or your group.</p>
					  </div>		
					</div>
					<div class="radio">
					  <label><input type="radio" class="radio" name="fasttrack" style="top: 3px;" onclick="radio_check_extra(2)">Airport Fasttrack - Normal</label>
					  <div style="padding: 14px;display: none;" id="radio-visa-extra-2">
					  	<p>To avoid wasting your time for queue to get visa stamp at landing visa counter, our dedicated team will handle all of it when you arrival. Fee $30/Per</p>
					  </div>
					</div>
					<div class="radio">
					  <label><input type="radio" class="radio" name="fasttrack" style="top: 3px;" onclick="radio_check_extra(3)">Airport Fasttrack - VIP</label>
					  <div style="padding: 14px;display: none;" id="radio-visa-extra-3">
					  	<p>With this VIP Fast-Track immigration service & special assistance at Vietnam airport. Our team will getting fast visa stamp and your luggages to taxi stand. Fee $45 /per</p>
					  </div>
					</div>
			      </div>
			    </div>
			...
			<div class="show-info-visa">
				...
				<div class="show-info-visa-detail">
					...
					<div class="item">
						...
						<p style="color: red;">noted: Allow to exit Vietnam anytime & any ports during valid visa</p>
					</div>
					<div class="item">
						<label>Arrival airport:</label>
						<span>Noi Bai (Hanoi city)</span>
					</div>
					<div class="item">
						<label style="float: left;">Processing time:</label>
						<span id="processing_time">Standard 2 Working days (Business hour Mon to Fri)</span>
					</div>
					<div class="item">
					...
					<div class="item">
						...
						<span id="rush-fee">0$ x 1 person = 0$ USD</span>
					</div>
					<div class="item">
						<label>Express fee:</label>
						<span id="express_fee">0 USD</span>
					</div>
...
<script type="text/javascript">
	...
	function countryf (data) {
		...
		if (national != 0) {
			...
			//   xhttp.onreadystatechange = function() {
			//     if (this.readyState == 4 && this.status == 200) {
			//      country_fee = this.responseText;
			//      var fee_service_country = parseInt(country_fee) + 10;
			//      document.getElementById("service_fee").innerHTML = fee_service_country+'$ x 1 Person = '+fee_service_country+'$ USD';
			//     }
			//   };
			//   xhttp.open("GET", "/functions/ajax/country_fee.php?id="+national, true);
			//   xhttp.send();
		}
	}
	...
	function set_total () {
		if (rush == 180) {
			...
			var total = parseInt(service_fee) +  parseInt(fasttrack_price) +  parseInt(private_price) +  parseInt(express_fee) +  parseInt(country_fee);
		}
	...
	function nextf () {
		...
		if (country == 0) {
			...
			var xhttp = new XMLHttpRequest();
			  ...
			  xhttp.open("GET", "/functions/ajax/set_step_1.php?country="+country+"&purpose="+purpose+"&type="+type+"&entry_date="+entry_date+"&exit_date="+exit_date+"&airport="+airport+"&time="+time+"&private="+private+"&fasttrack="+fasttrack+"&price="+price+"&rush="+rush, true);
			  xhttp.send();
		}
	}
</script>
