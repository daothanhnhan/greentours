...
<div class="container info-visa-1">
	...
	<div class="row">
		<div class="col-md-7">
			...
			<form class="form-horizontal" action="/check-out-vietnam-evisa" method="post" enctype="multipart/form-data">
				<div id="info-more">
					<div>
			...
			<div class="show-info-visa">
				...
				<div class="show-info-visa-detail">
					...
					<div class="item">
						...
						<span><?= $action->getDetail('vietnam_port_evisa', 'id', $_SESSION['info_order_visa']['airport'])['name'] ?></span>
					</div>
					<div class="item">
