			...
			<form class="form-horizontal" action="/action_page.php">
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-sm-8">
			        ...
			        <div style="margin-top: 7px;"><span style="color: red;">Noted: It’s the date of arrival Cambodia airport</span></div>
			...
			<div class="show-info-visa">
				...
				<div class="show-info-visa-detail">
					...
					<div class="item">
						...
						<p style="color: red;">noted: Allow to exit Cambodia anytime & any ports during valid visa</p>
					</div>
					<div class="item">
					...
					<div class="item">
						...
						<span>36$ x 1 Person = 36$ USD</span>
					</div>
			  ...
			  xhttp.onreadystatechange = function() {
			    if (this.readyState == 4 && this.status == 200) {
			     // document.getElementById("demo").innerHTML = this.responseText;
			     	window.location.href = "/applicant-details-cambodia-evisa";
			    }
			  };
