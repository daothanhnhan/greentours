  ...
  function order () {
    ...
    if (isset($_POST['thanh_toan'])) {
      try {
        ...
        $airport = $action->getDetail('laos_port_evisa', 'id', $_SESSION['info_order_visa']['airport'])['name'];
        ...
        $sql = "INSERT INTO order_evisa (purpose, type, date_entry, date_exit, port, price, country, `time`, total, gov) VALUES ('$purpose', '$type', '$entry_date', '$exit_date', '$airport', ?, 2,'$time', 0, $gov)";
        // echo $sql;
...
if (empty($_SESSION['contact_visa'])) {
  header('location: /applicant-details-laos-evisa');
}
      ...
      <div class="payment">
        ...
        <div class="content">
          ...
          <div class="img-center" style="text-align: center;">
            <!-- <a href="/order-evisa-laos"><img src="/images/green/pay_paypal.png" alt=""></a> -->
