            ...
            <article id="node-600" class="node node-page clearfix">
                ...
                <div class="founder">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 no-pad-r"><img

                                src="/images/<?= $founder['page_img'] ?>" class="ava_gd" alt="">

                        </div>

                        <div class="col-sm-8 info-gd">

                            <p class="tit-gd"><b><?= $founder['page_name'] ?></b><br>

                                <span style="font-weight:300;color: #000;">FOUNDER AND DIRECTOR</span></p>
