<?php
    if (isset($_GET['search']) && $_GET['search'] != '') {
        $rows = $action->getSearchAdmin('user',array('user_name','user_phone'), $_GET['search'],$trang,10,$_GET['page']);
    }else{
       
        $rows = $acc->getList("user","","","","asc",$trang, 20, "tai-khoan-user");
    }
                ...
                <?php 
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="float: none;"><a href="index.php?page=xoa-tai-khoan-user&id=<?= $row['user_id'] ?>" style="float: none;" onclick="return confirm('Bạn có chắc muốn xóa.')">Xóa</a></td>
                        </tr>
                    <?php
                    }
                ?>
