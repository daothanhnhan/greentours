<?php 
	...
	function golf ($id) {
		...
		if (isset($_POST['add_holiday'])) {
			...
			try {
				...
				$sql = "UPDATE golf SET name = ?, note = ? $add WHERE id = $id";//echo $sql;
				...
				$stmt->execute();
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một Golf.\')</script>';
			}
			catch (Exception $e) {
	...
	golf($_GET['id']);
	$info = $action->getDetail('golf', 'id', $_GET['id']);
?>
