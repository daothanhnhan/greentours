<?php 
	$info = $action->getDetail('order_visa', 'id', $_GET['id']);
	$contact = $action->getDetail('info_contact', 'order_visa_id', $_GET['id']);
	...
	///////////
	$person = $action->getList('info_person', 'order_visa_id' , $_GET['id'], 'id', 'asc', '', '', '');
?>
<div class="container">
