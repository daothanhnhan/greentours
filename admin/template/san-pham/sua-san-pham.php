...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="float: none;"><a style="float: none;" href="index.php?page=hanh-trinh&product_id=<?= $row['product_id'] ?>">HÀNH TRÌNH</a></p>
            <br>
            <p style="float: none;"><a style="float: none;" href="index.php?page=bang-gia&product_id=<?= $row['product_id'] ?>">BẢNG GIÁ</a></p>
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor2" name="product_des2"><?php echo $row_showMain['lang_product_des2'];?></textarea></p>

            <p class="titleRightNCP">Is this trip right for you?:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor3" name="product_des3"><?php echo $row_showMain['lang_product_des3'];?></textarea></p> -->

            <p class="titleRightNCP">Important notes:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor4" name="product_content2"><?php echo $row_showMain['lang_product_content2'];?></textarea></p>

            <p class="titleRightNCP">Meals:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor5" name="product_sub_info1"><?php echo $row_showMain['lang_product_sub_info1'];?></textarea></p>

            <p class="titleRightNCP">Transport:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor6" name="product_sub_info2"><?php echo $row_showMain['lang_product_sub_info2'];?></textarea></p>

            <p class="titleRightNCP">Accommodation:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor7" name="product_sub_info3"><?php echo $row_showMain['lang_product_sub_info3'];?></textarea></p>

            <p class="titleRightNCP">Included activities:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor8" name="product_sub_info4"><?php echo $row_showMain['lang_product_sub_info4'];?></textarea></p>
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <?php 
                    if ($row['map_img'] != '') {
                    ?>
                        <img src="../images/<?= $row['map_img']?>" class="img-responsive" alt="Image" width="200">
                        <input type="hidden" name="map_img" value="<?= $row['map_img']?>">
                    <?php
                    }
                ?>                
                </div>
        ...
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <?php 
                    if ($row['banner'] != '') {
                    ?>
                        <img src="../images/<?= $row['banner']?>" class="img-responsive" alt="Image" width="200">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['banner_text'];?>" name="banner_text"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <div id="size">
                        ...
                        <div class="del-input">
                            <input type="date" class="txtNCP1" value="<?php echo $item;?>" name="product_size[]"/>
    ...
    <script type="text/javascript">
        function add_size () {
            ...
            document.getElementById('size').innerHTML = size + '<div class="del-input"><input type="date" class="txtNCP1" value="" name="product_size[]"/><button type="button" onclick="del_size(this)">Xóa</button></div>';
        }
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['start'];?>" name="start"/>
                ...
                <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['finish'];?>" name="finish"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['destination'];?>" name="destination"/>
                ...
                <!-- <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['style'];?>" name="style"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['theme'];?>" name="theme"/>
                ...
                <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['code'];?>" name="code"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['rating'];?>" name="rating"/>
                ...
                <!-- <div class="subColContent" >
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['ages'];?>" name="ages"/>
            ...
            <div class="rowNCP">
                ...
                <!-- <div class="subColContent">
                    ...
                    <input type="text" class="txtNCP1" value="<?php echo $row['group_size'];?>" name="group_size"/>
            ...
            <!-- <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="date" class="txtNCP1" value="<?php echo $row['product_original'];?>" name="product_original"/>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_new" <?= $row['product_new'] == 1 ? 'checked' : '' ?>>Highlight Home
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_hot" <?= $row['product_hot'] == 1 ? 'checked' : '' ?>>Highlight Golf tour
