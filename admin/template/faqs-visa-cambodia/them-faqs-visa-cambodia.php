<?php 
	...
	function faqs () {
		...
		if (isset($_POST['add_faqs'])) {
			...
			$sql = "INSERT INTO faqs_visa_cambodia (name, note) VALUES ('$name', '$note')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một câu hỏi.\');window.location.href="index.php?page=faqs-visa-cambodia"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=faqs-visa-cambodia">Quay lại</a><br /><br /></p>     
