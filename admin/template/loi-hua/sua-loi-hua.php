<?php 
	...
	function loi_hua ($id) {
		...
		if (isset($_POST['add_promises'])) {
			...
			$sql = "UPDATE promises SET name = '$name', note = '$note' $add WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một Promises.\')</script>';
			} else {
	...
	loi_hua($_GET['id']);
	$info = $action->getDetail('promises', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP">Nhập thông tin Promises<br /><br /></p>     
        ...
        <div class="boxNodeContentPage">
            ...
            <img src="/images/<?= $info['image'] ?>" alt="" width="150">
