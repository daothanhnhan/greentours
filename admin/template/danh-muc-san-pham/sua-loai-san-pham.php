...
<?php
    ...
    /////////
    $template = $action->getList('template', '', '', 'id', 'asc', '', '', '');
?>
...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Chọn giao diện</p>
            <select name="type" class="txtNCP1">
                <?php foreach ($template as $item) { ?>
                <option value="<?= $item['id'] ?>" <?= $item['id']==$row['type'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                <?php } ?>
            </select>

            <p class="titleRightNCP"><a href="index.php?page=danh-muc-tour-faqs&productcat_id=<?= $_GET['id'] ?>">FAQS</a></p>

            <p class="titleRightNCP"><a href="index.php?page=holiday-cat&productcat_id=<?= $_GET['id'] ?>">Holiday</a></p>
            ...
            <p class="titleRightNCP">Responsible Travel 1</p>
            ...
            <p class="titleRightNCP">Title</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor3" name="productcat_sub_info1" ><?= $row_showMain['lang_productcat_sub_info1'];?></textarea></p>

            <p class="titleRightNCP">Video</p>
            <textarea class="longtxtNCP1 ckeditor1" id="editor4" name="productcat_sub_info2" ><?= $row_showMain['lang_productcat_sub_info2'];?></textarea>
        </div>
