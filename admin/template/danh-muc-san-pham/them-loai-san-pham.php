...
<form action="" method="post" accept-charset="utf-8" id="addProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor3" name="productcat_sub_info1" ></textarea></p>

            <p class="titleRightNCP">Video</p>
            <textarea class="longtxtNCP1 ckeditor1" id="editor4" name="productcat_sub_info2" ></textarea>
