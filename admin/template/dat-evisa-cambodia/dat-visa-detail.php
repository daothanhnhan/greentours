<?php 
	$info = $action->getDetail('order_evisa', 'id', $_GET['id']);
	$contact = $action->getDetail('info_contact_evisa', 'order_evisa_id', $_GET['id']);
	...
	///////////
	$person = $action->getList('info_person_evisa', 'order_evisa_id' , $_GET['id'], 'id', 'asc', '', '', '');
?>
<div class="container">
