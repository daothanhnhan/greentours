<?php 
	...
	function holiday ($id) {
		...
		if (isset($_POST['add_holiday'])) {
			...
			try {
				...
				$sql = "UPDATE holiday_cat SET name = ?, note = ? $add WHERE id = $id";//echo $sql;
	...
	holiday($_GET['id']);
	$info = $action->getDetail('holiday_cat', 'id', $_GET['id']);
?>
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=holiday-cat&productcat_id=<?= $info['productcat_id'] ?>">Quay lại</a><br /><br /></p>     
