	...
	function holiday () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			try {
				...
				$sql = "INSERT INTO holiday_cat (name, image, note, productcat_id) VALUES (?, ?, ?, $productcat_id)";
				$stmt = $conn_vn->prepare($sql);
				$stmt->bind_param("sss", $name, $image, $note);
				$stmt->execute();
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một Holiday.\');window.location.href="index.php?page=holiday-cat&productcat_id='.$productcat_id.'"</script>';
			}
			catch (Exception $e) {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            ...
            <p class="subLeftNCP"><a href="index.php?page=holiday-cat&productcat_id=<?= $_GET['productcat_id'] ?>">Quay lại</a><br /><br /></p>     
