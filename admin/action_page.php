...
class action_page extends library{
	...
	/*-------------- Cấu hình trang chủ --------------------*/
		...
		public function updateConfig(){
			...
			$gmap = isset($_POST['gmap']) ? $_POST['gmap'] : '';
	...
	/*--------------- Danh mục sản phẩm -------------------*/
		...
		public function deleteProductCat(){
			...
			if ($productcat_id == 124 || $productcat_id == 139 || $productcat_id == 140 || $productcat_id == 141 || $productcat_id == 142 || $productcat_id == 143 || $productcat_id == 144 || $productcat_id == 145 || $productcat_id == 146 || $productcat_id == 147 || $productcat_id == 148 || $productcat_id == 149 || $productcat_id == 150 || $productcat_id == 151 || $productcat_id == 152 || $productcat_id == 153 || $productcat_id == 154 || $productcat_id == 155 || $productcat_id == 159) {
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$group_size = isset($_POST['group_size']) ? $_POST['group_size'] : '';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssssssssssssssissssiiisi');
   ...
   //          }
	...
	/*----------------- Trang nội dung -------------------*/
		...
		public function deletePage(){
			...
			if ($page_id == 36 || $page_id == 37 || $page_id == 39 || $page_id == 40 || $page_id == 41 || $page_id == 43 || $page_id == 47 || $page_id == 48 || $page_id == 51 || $page_id == 52 || $page_id == 53 || $page_id == 45 || $page_id == 46) {
				echo json_encode(array('error'=>'Mục này không được xóa.'));die;
			}
...
/*---------------- Danh mục dịch vụ --------------------*/
	...
	/*------------------ dịch vụ -------------------*/
		...
		public function updateProductTag(){
			...
			$producttag_price = isset($_POST['producttag_price']) ? $_POST['producttag_price'] : '0';

			$bao_gom = isset($_POST['bao_gom']) ? $_POST['bao_gom'] : '';

			$ngay_di = isset($_POST['ngay_di']) ? $_POST['ngay_di'] : '0000-00-00';

			$ngay_den = isset($_POST['ngay_den']) ? $_POST['ngay_den'] : '0000-00-00';
