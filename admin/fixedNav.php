           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Employment</a></li>
            ...
            <li><a href="index.php?page=team" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Our Team</a>
            </li>

            <li><a href="index.php?page=apply-job" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Apply job</a>
            </li>

            <li><a href="index.php?page=dat-visa" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt visa việt nam</a>
            </li>

            <li><a href="index.php?page=dat-evisa-vietnam" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt evisa việt nam</a>
            </li>

            <li><a href="index.php?page=dat-evisa-laos" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt evisa Lào</a>
            </li>

            <li><a href="index.php?page=dat-evisa-cambodia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt evisa Cambodia</a>
            </li>

            <li><a href="index.php?page=cau-hoi" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Faqs Visa Vietnam</a>
            </li>

            <li><a href="index.php?page=faqs-visa-laos" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Faqs Visa Loas</a>
            </li>

            <li><a href="index.php?page=faqs-visa-cambodia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Faqs Visa Cambodia</a>
            </li>

            <li><a href="index.php?page=holiday" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Holiday infor</a>
            </li>

            <li><a href="index.php?page=golf" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Golf Services</a>
            </li>

            <li><a href="index.php?page=why" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Why</a>
            </li>

            <li><a href="index.php?page=cam-nhan" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Our Promises</a>
            </li>

            <li><a href="index.php?page=thuong-hieu" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Our associations</a>
            </li>

            <li><a href="index.php?page=our-contact" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Our Contace</a>
            </li>
            ...
            <li><a href="index.php?page=tag-san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tag-san-pham' || $_GET["page"] == 'them-tag-san-pham' || $_GET["page"] == 'sua-tag-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Combo</a>
            </li>

            <li><a href="index.php?page=customize" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Customize tour</a>
            </li>

            <li><a href="index.php?page=book-tour" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Book tour</a>
            </li>

            <li><a href="index.php?page=dat-combo" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Book combo</a>
            </li>

            <li><a href="index.php?page=feedback" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Feedback</a>
            </li>

            <!-- <li><a href="index.php?page=bang-gia" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Bảng giá</a>
            </li> -->

            <!-- <li><a href="index.php?page=video" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Video</a>
            </li>

            <li><a href="index.php?page=cam-nhan" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ý kiến</a>
            </li> -->
