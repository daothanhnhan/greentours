...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Thông tin tài khoản</p>
            ...
            <p class="titleRightNCP">Chính sách</p>
            ...
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['facebook']?>" name="facebook"/>

            <p class="titleRightNCP">Twitter</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['twitter']?>" name="twitter"/>

            <p class="titleRightNCP">Youtube</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['youtube']?>" name="youtube"/>

            <p class="titleRightNCP">instagram</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['instagram']?>" name="instagram"/>

            <p class="titleRightNCP">Pinterest</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['pinterest']?>" name="pinterest"/>

            <p class="titleRightNCP">Google map</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['gmap']?>" name="gmap"/>
        </div>
    </div><!--end rowNodeContentPage-->
